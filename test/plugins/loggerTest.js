...
describe('logger', () => {
    describe('exports', () => {
        let fns = ['begin', 'stop', 'getTime', 'logEvent'],
            objs = ['defaults', 'config'];
        describe('should export expected functions:', () => {
            fns.forEach((fn) => {
                it(fn + '()', () => expect(logger[fn]).to.be.a('function'));
            });
        });
        ...
        it('should export only expected keys', () => {
            logger.should.have.all.keys(fns.concat(objs));
        });
    });
    describe('getTime()', () => {
    ...
    describe('logEvent()', () => {
        ...
        describe('should produce expected output for test input:', () => {
            [
    ...
    describe('begin()', () => {
        describe('should register listener for event:', () => {
    ...
    describe('Event Handlers', () => {
        describe('should log expected output for input event:', () => {
            const events = {},
                client = {
